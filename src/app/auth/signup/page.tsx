        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link className="mb-5.5 inline-block" href="/">
                <h4 className="text-center text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                  Autenticação
                </h4>
              </Link>
              <p className="2xl:px-20">
                Seja bem-vindo,
                crie sua conta e faça a gestão de seus hábitos de maneira produtiva
                e mais dinâmica em nossa a plataforma.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Cuide de seus hábitos</span>
